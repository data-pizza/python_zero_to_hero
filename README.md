...
Recursive Functions | Advanced 👉🏻 https://python-course.eu/advanced-python/recursive-functions.php
...
Step 1: Create and run your first Python project | PyCharm 👉🏻 https://www.jetbrains.com/help/pycharm/creating-and-running-your-first-python-project.html#edit-file)
...
4. Lambda Operator, filter, reduce and map | Advanced 👉🏻 https://python-course.eu/advanced-python/lambda-filter-reduce-map.php
...
- Python Database Tutorial - GeeksforGeeks 👉🏻 https://www.geeksforgeeks.org/python-database-tutorial/
...
Magic Methods | OOP  👉🏻 https://python-course.eu/oop/magic-methods.php

### List Comprehension

List Comprehension | Advance 👉🏻 https://python-course.eu/advanced-python/list-comprehension.php
...
Testing with Pytest | Advanced 👉🏻 https://python-course.eu/advanced-python/pytest.php

### Regular Expressions

Regular Expressions | Advanced 👉🏻 https://python-course.eu/advanced-python/regular-expressions.php

Advanced Regular Expressions | Advanced 👉🏻 https://python-course.eu/advanced-python/advanced-regular-expressions.php

### Decorators & Memoization

Decorators and Decoration | Advanced 👉🏻 https://python-course.eu/advanced-python/decorators-decoration.php

Memoization and Decorators | Advanced 👉🏻 https://python-course.eu/advanced-python/memoization-decorators.php

### Generators

Generators and Iterators | Advanced 👉🏻 https://python-course.eu/advanced-python/generators-and-iterators.php
...
- Python Multithreading Tutorial: Concurrency and Parallelism 👉🏻 https://realpython.com/intro-to-python-threading/
- Python Multiprocessing: The Pool and Process Classes 👉🏻 https://www.youtube.com/watch?v=fKl2JW_qrso
- Python Multithreading and Multiprocessing 👉🏻 https://towardsdatascience.com/multithreading-multiprocessing-python-180d0975ab29
...
Intro to Machine Learning with Python | Machine Learning 👉🏻 https://python-course.eu/machine-learning/
